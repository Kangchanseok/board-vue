...
.top-section {
  height: 100vh;
  background: url("https://images.unsplash.com/photo-1568743295327-cfc48ccc456d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80") no-repeat center;
