<template>
  ...
  <div class="create-all">
    ...
    <br/>
    <br/>
    <b-button class="btn-c" variant="primary" @click="updateMode ? updateContent() : uploadContent()">저장</b-button>
    <b-button class="btn-c" @click="updateMode ? cancle2(): cancle()">취소</b-button>
